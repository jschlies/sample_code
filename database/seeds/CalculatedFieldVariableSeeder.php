 ...
 */
class CalculatedFieldVariableSeeder extends Seeder
{
    /**
     * CalculatedFieldVariableSeeder constructor.
    ...
    public function __construct($seeder_provided_attributes_arr = [], $count = 1, $factory_name = self::DEFAULT_FACTORY_NAME)
    {
        ...
        $this->setResultingClass(CalculatedFieldVariable::class);
        $this->ModelRepositoryObj = App::make(CalculatedFieldVariableRepository::class)->setSuppressEvents(true);
    }
