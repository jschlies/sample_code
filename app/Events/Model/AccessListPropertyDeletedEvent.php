...
/**
 * Class AccessListPropertyDeletedEvent
 * @package App\Waypoint\Events
 */
class AccessListPropertyDeletedEvent extends RepositoryEventBase
{
     ...
     *
     * AccessListPropertyDeletedEvent constructor.
    ...
    public function __construct(AccessListProperty $AccessListPropertyObj, $options = [])
    {
        ...
        {
            $this->model_arr['launch_job_property_id_arr'] = $AccessListPropertyObj->accessList->properties->pluck('id')->toArray();
        }
