 ...
 */
class PropertyGroupPropertyCreatedEvent extends RepositoryEventBase
{
    ...
    public function __construct(PropertyGroupProperty $PropertyGroupPropertyObj, $options = [])
    {
        ...
        {
            $this->model_arr['launch_job_user_id_arr'] = $PropertyGroupPropertyObj->propertyGroup->client->users->pluck('id')->toArray();
        }
