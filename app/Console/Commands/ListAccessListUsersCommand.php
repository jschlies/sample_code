 ...
 * @codeCoverageIgnore
 */
class ListAccessListUsersCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'waypoint:list:access_list_users 
     ...
     * @var string
     */
    protected $description = 'List client access list user information';
    ...
    public function handle()
    {
        ...
        foreach ($this->getClientsFromArray($this->option('client_ids')) as $ClientObj)
        {
            ...
            {
                foreach ($AccessListObj->users as $UserObj)
                {
                    $return_me[] = [
