...
use App\Waypoint\Jobs\PreCalcPropertiesJob;
use App\Waypoint\Models\Client;
use Log;

/**
 * Class PreCalcPropertiesListener
 * @package App\Waypoint\Listeners
 *
 * See https://laravel.com/docs/5.4/events
 * See https://laravel.com/docs/5.4/queues
 */
class PreCalcPropertiesListener extends Listener
{
    /** @var array */
    ...
    {
        $this->job_class = PreCalcPropertiesJob::class;
        $this->queue     = ['QueueName' => config('queue.queue_lanes.PreCalcProperties', false)];
        parent::__construct();
    }
     ...
     *
     * @param PreCalcPropertiesEvent|\App\Waypoint\Events\EventBase $EventObj
    ...
    public function handle($EventObj = null)
    {
        ...
        if ( ! isset($EventObj->model_arr['launch_job_property_id_arr']))
        {
            $EventObj->model_arr['launch_job_property_id_arr'] = $ClientObj->properties->pluck('id')->toArray();
        }
