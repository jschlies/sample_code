...
Route::get(
    '/clients',
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_client_detail',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_property_details',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_property_code_mapping',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_boma_coa_codes',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_waypoint_boma_coa_mapping',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_client_sftp_details',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_wp_asset_type',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_version_metadata',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_column_datatypes',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_waypoint_account_codes',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_occupancy_lease_type_d',
...
Route::get(
    '/clients/map',
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_client_detail_map',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_report_templates',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_report_template_coas',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_report_template_coas_detail',
...
Route::get(
    ...
    [
        'as'   => 'api.v1.WaypointMasterBridgeController.index_report_template_cross_reference',
