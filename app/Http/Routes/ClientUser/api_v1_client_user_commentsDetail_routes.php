...
Route::group(
    ...
    function ()
    {
        Route::get(
            ...
            [
                'as'   => 'api.v1.CommentDetailController.show',
                'uses' => 'CommentDetailController@show',
            ]
        );
        Route::get(
            '/clients/{client_id}/commentsDetail/commentable_type/{commentable_type}/commentable_id/{commentable_id}',
            [
                'as'   => 'api.v1.CommentDetailController.index',
                'uses' => 'CommentDetailController@index',
            ]
        );
        Route::post(
            '/clients/{client_id}/commentsDetail/commentable_type/{commentable_type}/commentable_id/{commentable_id}',
            [
                'as'   => 'api.v1.CommentDetailController.store',
                'uses' => 'CommentDetailController@store',
            ]
        );
        Route::delete(
            '/clients/{client_id}/commentsDetail/{comment_id}',
            [
                'as'   => 'api.v1.CommentDetailController.destroy',
                'uses' => 'CommentDetailController@destroy',
            ]
        );
    }
);
