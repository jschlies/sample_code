 ...
 */
class UserPublicController extends BaseApiController
{
    use Notifiable;
     ...
     */
    public function update($client_id, $user_id, UpdateUserRequest $UserRequestObj)
    {
        $input = $UserRequestObj->all();
     ...
     * @throws ValidatorException
     */
    public function updateAdmin($client_id, $user_id, UpdateUserRequest $UserRequestObj)
    {
        $input = $UserRequestObj->all();
        if (
            isset($input['is_hidden']) &&
     ...
     * @throws ValidatorException
     */
    public function update_is_hidden($client_id, $user_id, UpdateUserRequest $UserRequestObj)
    {
