...
class FavoriteController extends BaseApiController
{
     ...
     * @return \Illuminate\Http\JsonResponse|null
     */
    public function show($client_id, $favorite_id)
    {
     ...
     * @return \Illuminate\Http\JsonResponse|null
     */
    public function store(CreateFavoriteRequest $FavoriteRepositoryRequest, $client_id)
    {
     ...
     * @throws \Exception
     */
    public function destroy($client_id, $favorite_id)
    {
        /** @var Favorite $FavoriteObj */
