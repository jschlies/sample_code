...
class ReportTemplateReportController extends BaseApiController
{
    /**
     ...
     */
    public function show($client_id, $report_template_id, Request $request)
    {
        /**
        ...
        {
            return $this->sendResponse($ReportTemplateObj->reportTemplateAccountGroups, 'ReportTemplate(s) retrieved successfully');
        }
