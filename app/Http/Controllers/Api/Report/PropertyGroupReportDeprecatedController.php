 ...
 * @codeCoverageIgnore
 */
class PropertyGroupReportDeprecatedController extends BaseApiController
{
     ...
     */
    public function list_property_groups_by_client_id_old(Request $RequestObj, $client_id_old)
    {
