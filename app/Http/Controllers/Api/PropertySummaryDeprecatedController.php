...
/**
 * Class PropertySummaryDeprecatedController
 * @codeCoverageIgnore
 */
class PropertySummaryDeprecatedController extends BaseApiController
{
    ...
    public function index(Request $Request)
    {
        ...
        $PropertyObjArr = $this->PropertySummaryRepositoryObj->findWhere(['client_id' => $this->getCurrentLoggedInUserObj()->client_id]);
