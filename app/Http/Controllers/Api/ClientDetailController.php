 ...
 */
class ClientDetailController extends BaseApiController
{
    ...
    public function renderPreCalcStatusClient($client_id, UpdateClientRequest $ClientRequestObj)
    {
        ...
        $user_count           = $pre_calc_status_arr->whereNotIn('user_id', [null])->count();
     ...
     * @throws GeneralException
     */
    public function showAudits($client_id)
    {
        /** @var Client $AdvancedVarianceObj */
        $ClientObj = $this->ClientDetailRepositoryObj->find($client_id);
        return $this->sendResponse($ClientObj->getAuditArr(), 'Client audits retrieved successfully');
    }
}
