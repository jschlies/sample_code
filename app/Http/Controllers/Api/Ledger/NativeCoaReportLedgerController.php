...
/**
 * Class NativeCoaReportLedgerController
 */
class NativeCoaReportLedgerController extends LedgerController
{
     ...
     */
    public function getPropertyReport($client_id, $property_id)
    {
     ...
     * @return \Illuminate\Http\JsonResponse|null
     */
    public function getPropertyGroupReport($client_id, $property_group_id)
    {
