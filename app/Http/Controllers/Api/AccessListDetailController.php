...
/**
 * Class AccessListDetailController
 */
class AccessListDetailController extends BaseApiController
{
     ...
     */
    public function show($client_id, $access_list_id)
    {
     ...
     * @todo Huh???
     */
    public function getAccessListDetailForUser($client_id, $user_id)
    {
        $UserObj =
     ...
     */
    public function store(CreateAccessListRequest $CreateAccessListRequestObj, $client_id)
    {
