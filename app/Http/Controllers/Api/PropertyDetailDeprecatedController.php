...
/**
 * Class PropertyDetailDeprecatedController
 * @codeCoverageIgnore
 */
class PropertyDetailDeprecatedController extends BaseApiController
{
    /**
     * @var boolean
     */
     ...
     * @throws \Prettus\Repository\Exceptions\RepositoryException
     */
    public function showUsers(Request $Request, $property_id)
    {
        $this->PropertyDetailRepositoryObj->pushCriteria(new RequestCriteria($Request));
        $this->PropertyDetailRepositoryObj->pushCriteria(new LimitOffsetCriteria($Request));
     ...
     */
    public function update($property_id, UpdatePropertyRequest $PropertyRequestObj)
    {
