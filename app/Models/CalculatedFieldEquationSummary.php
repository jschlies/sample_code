 ...
 */
class CalculatedFieldEquationSummary extends CalculatedFieldEquation
{
    /**
    ...
    public function toArray(): array
    {
        return [
            ...
            "calculatedFieldEquationProperties" => $this->calculatedFieldEquationProperties->getArrayOfIDs(),
            "calculatedFieldVariables"          => $this->calculatedFieldVariables->getArrayOfIDs(),
