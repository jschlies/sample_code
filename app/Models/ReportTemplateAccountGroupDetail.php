...
/**
 * Class ReportTemplateAccountGroupDetail
 * @package App\Waypoint\Models
 */
class ReportTemplateAccountGroupDetail extends ReportTemplateAccountGroup
{
    /**
    ...
    public function toArray(): array
    {
        return [
            ...
            "nativeAccountType"                       => $this->nativeAccountType,
