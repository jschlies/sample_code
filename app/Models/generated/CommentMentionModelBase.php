 ...
 *
 * @method static CommentMention find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static CommentMention|Collection findOrFail($id, $columns = ['*']) desc
 */
class CommentMentionModelBase extends Model
{
    /**
     * Generated
     */
    ...
    {
        $this->setTable('comment_mentions');
        $this->setFillable(
            [
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(CommentMention::$baseRules, CommentMention::$rules);
        }
