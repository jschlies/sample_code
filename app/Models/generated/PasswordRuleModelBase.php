 ...
 * Class PasswordRule
 *
 * @method static PasswordRule find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static PasswordRule|Collection findOrFail($id, $columns = ['*']) desc
 */
class PasswordRuleModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static $baseRules = [
        ...
        'password_rule_type' => 'required|max:255',
        'description'        => 'sometimes|nullable|min:3|max:255',
        'regular_expression' => 'required|max:255',
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(PasswordRule::$baseRules, PasswordRule::$rules);
        }
