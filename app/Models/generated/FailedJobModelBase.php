 ...
 * Class FailedJob
 *
 * @method static FailedJob find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static FailedJob|Collection findOrFail($id, $columns = ['*']) desc
 */
class FailedJobModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(FailedJob::$baseRules, FailedJob::$rules);
        }
