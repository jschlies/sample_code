 ...
 *
 * @method static TenantTenantAttribute find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static TenantTenantAttribute|Collection findOrFail($id, $columns = ['*']) desc
 */
class TenantTenantAttributeModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static $baseRules = [
        ...
        'tenant_attribute_id' => 'sometimes|integer',
    ...
    {
        $this->setTable('tenant_tenant_attributes');
        $this->setFillable(
            [
     ...
     **/
    public function tenantAttribute()
    {
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(TenantTenantAttribute::$baseRules, TenantTenantAttribute::$rules);
        }
