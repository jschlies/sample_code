 ...
 * Class RoleUser
 *
 * @method static RoleUser find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static RoleUser|Collection findOrFail($id, $columns = ['*']) desc
 */
class RoleUserModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(RoleUser::$baseRules, RoleUser::$rules);
        }
