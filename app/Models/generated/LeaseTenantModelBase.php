 ...
 * Class LeaseTenant
 *
 * @method static LeaseTenant find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static LeaseTenant|Collection findOrFail($id, $columns = ['*']) desc
 */
class LeaseTenantModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(LeaseTenant::$baseRules, LeaseTenant::$rules);
        }
