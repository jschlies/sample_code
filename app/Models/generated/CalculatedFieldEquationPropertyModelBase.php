...
/**
 * Class CalculatedFieldEquationProperty
 *
 * @method static CalculatedFieldEquationProperty find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static CalculatedFieldEquationProperty|Collection findOrFail($id, $columns = ['*']) desc
 */
class CalculatedFieldEquationPropertyModelBase extends Model
{
    /**
     * Generated
     */
    ...
    {
        $this->setTable('calculated_field_equation_properties');
        $this->setFillable(
            [
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(CalculatedFieldEquationProperty::$baseRules, CalculatedFieldEquationProperty::$rules);
        }
