 ...
 *
 * @method static PropertyGroupProperty find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static PropertyGroupProperty|Collection findOrFail($id, $columns = ['*']) desc
 */
class PropertyGroupPropertyModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static $baseRules = [
        ...
        'property_group_id' => 'sometimes|integer',
    ...
    {
        $this->setTable('property_group_properties');
        $this->setFillable(
            [
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(PropertyGroupProperty::$baseRules, PropertyGroupProperty::$rules);
        }
