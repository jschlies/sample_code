 ...
 *
 * @method static NativeAccountAmount find($id, $columns = ['*']) desc
 * @method static Collection all($columns = ['*']) desc
 * @method static Collection findMany($ids, $columns = ['*']) desc
 * @method static NativeAccountAmount|Collection findOrFail($id, $columns = ['*']) desc
 */
class NativeAccountAmountModelBase extends Model
{
    /**
     * Generated
     */
    ...
    public static $baseRules = [
        ...
        'native_account_id'    => 'sometimes|integer',
        'month'                => 'sometimes|integer',
        'year'                 => 'sometimes|integer',
        'month_year_timestamp' => 'sometimes',
        'actual'               => 'sometimes|nullable|numeric',
    ...
    {
        $this->setTable('native_account_amounts');
        $this->setFillable(
            [
    ...
    public static function get_model_rules($rules = null, $object_id = null)
    {
        if ($rules == null)
        {
            $rules = array_merge(NativeAccountAmount::$baseRules, NativeAccountAmount::$rules);
        }
